...
class Recent_Posts_Widget extends WP_Widget
{
    function __construct()
    {
        parent::__construct(
            'ct_recent_posts',
            esc_html__( '* Recent Posts', 'multio' ),
            array(
                'description' => __( 'Shows your most recent posts.', 'multio' ),
    ...
    function widget( $args, $instance )
    {
        $instance = wp_parse_args( (array) $instance, array(
            'title'         => esc_html__( 'Recent Posts', 'multio' ),
            'number'        => 4,
            'post_in'        => '',
            'show_featured_image'        => '',
        ) );

        $title = empty( $instance['title'] ) ? esc_html__( 'Recent Posts', 'multio' ) : $instance['title'];
    ...
    function form( $instance )
    {
        ...
        $title         = $instance['title'] ? esc_attr( $instance['title'] ) : esc_html__( 'Recent Posts', 'multio' );
        $number        = absint( $instance['number'] );
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:', 'multio' ); ?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
        </p>

        <p><label for="<?php echo esc_url($this->get_field_id('post_in')); ?>"><?php esc_html_e( 'Post in', 'multio' ); ?></label>
         <select class="widefat" id="<?php echo esc_attr( $this->get_field_id('post_in') ); ?>" name="<?php echo esc_attr( $this->get_field_name('post_in') ); ?>">
            <option value="recent"<?php if( $post_in == 'recent' ){ echo 'selected="selected"';} ?>><?php esc_html_e('Recent', 'multio'); ?></option>
            <option value="featured"<?php if( $post_in == 'featured' ){ echo 'selected="selected"';} ?>><?php esc_html_e('Featured', 'multio'); ?></option>
         </select>
         </p>

         <p><label for="<?php echo esc_url($this->get_field_id('show_featured_image')); ?>"><?php esc_html_e( 'Featured Image', 'multio' ); ?></label>
         <select class="widefat" id="<?php echo esc_attr( $this->get_field_id('show_featured_image') ); ?>" name="<?php echo esc_attr( $this->get_field_name('show_featured_image') ); ?>">
            <option value="show"<?php if( $show_featured_image == 'show' ){ echo 'selected="selected"';} ?>><?php esc_html_e('Show', 'multio'); ?></option>
            <option value="hide"<?php if( $show_featured_image == 'hide' ){ echo 'selected="selected"';} ?>><?php esc_html_e('Hide', 'multio'); ?></option>
         </select>
         </p>

        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_html_e( 'Number of posts to show:', 'multio' ); ?></label>
