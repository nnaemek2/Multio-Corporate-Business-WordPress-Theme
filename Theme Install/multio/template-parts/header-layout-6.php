...
?>
<header id="masthead">
    <div id="header-wrap" class="header-layout6 header-trans <?php if($sticky_on == 1) { echo 'is-sticky'; } else { echo 'no-sticky'; } ?>" h-data-offset="100">
                ...
                <div class="row">
                    <div class="header-branding">
                        ...
                        <?php } else { 
                            ...
                            ?>
                            <div class="header-lang-item header-right-lang">
