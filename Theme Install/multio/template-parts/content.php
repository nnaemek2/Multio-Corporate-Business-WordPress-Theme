...
$btn_text_readmore = multio_get_opt( 'btn_text_readmore');
?>
    ...
    <div class="entry-blog">
        <?php if (has_post_format('gallery')) : ?>
            <div class="entry-featured entry-gallery">
                ...
                ?>
                <div class="ct-carousel owl-carousel featured-active <?php if($light_box) {echo 'images-light-box-carousel';} ?>" data-item-xs="1" data-item-sm="1" data-item-md="1" data-item-lg="1" data-item-xl="1" data-margin="30" data-margin-md="30" data-loop="true" data-autoplay="false" data-autoplaytimeout="5000" data-smartspeed="250" data-center="false" data-arrows="true" data-bullets="false" data-stagepadding="0" data-stagepadding-xl="0" data-stagepadding-lg="0" data-rtl="<?php echo esc_attr( $carousel_rtl ); ?>">
                    <?php
        ...
        <?php else :
            if (has_post_thumbnail()) {
                echo '<div class="entry-featured"><div class="post-image">'; ?>
                    <a href="<?php echo esc_url( get_permalink()); ?>"><?php the_post_thumbnail('multio-large'); ?></a>
                <?php echo '</div></div>';
            } ?>
        <?php endif; ?>
        <div class="entry-body">
            <div class="entry-holder">
                <?php multio_archive_meta(); ?>
            ...
            <div class="entry-readmore">
                <a class="btn" href="<?php echo esc_url( get_permalink()); ?>" >
                    <?php if(!empty($btn_text_readmore)) { 
                        ...
                        echo esc_html__( 'Read more', 'multio' );
                    } ?>
