...
?>
<header id="masthead">
    <div id="header-wrap" class="header-layout8 <?php if($sticky_on == 1) { echo 'is-sticky'; } else { echo 'no-sticky'; } ?>">
        <div id="header-top-bar">
            <div class="container">
                <div class="row">
                    <?php if(!empty($topbar_address)) : ?>
                        <div class="header-top-address">
                            <i class="fac fac-map-marker-alt"></i><?php echo esc_attr($topbar_address); ?>
                        </div>
                    <?php endif; ?>
