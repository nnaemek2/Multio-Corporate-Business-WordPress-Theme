...
vc_map(
    array(
        'name'     => esc_html__('Case Studies Grid', 'multio'),
        'base'     => 'ct_case_studies_grid',
        'class'    => 'ct-icon-element',
        'description' => esc_html__( 'Case Study in masonry grid', 'multio' ),
        'category' => esc_html__('CaseThemes Shortcodes', 'multio'),
        'params'   => array(
            array(
                'type' => 'cms_template_img',
                'param_name' => 'cms_template',
                'shortcode' => 'ct_case_studies_grid',
                'heading' => esc_html__('Shortcode Template', 'multio'),
                'admin_label' => true,
                'std' => 'ct_case_studies_grid.php',
            ...
            array(
                ...
                'param_name' => 'img_size',
                'value' => '',
                'description' => __( 'Enter image size (Example: "thumbnail", "medium", "large", "full" or other sizes defined by theme). Alternatively enter size in pixels (Example: 200x100 (Width x Height). Enter multiple sizes (Example: 100x100,200x200,300x300)).', 'multio' ),
...
class WPBakeryShortCode_ct_case_studies_grid extends CmsShortCode
{
