...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-grid ct-grid-case-layout1 <?php echo esc_attr($el_class); ?>">
                    ...
                    <div class="<?php echo esc_attr($item_class . ' ' . $filter_class); ?>">
                        <div class="grid-item-inner wpb_animate_when_almost_visible wpb_fadeIn fadeIn">
                            ...
                            <div class="item-body">
                                ...
                                <?php if(!empty($case_study_except)) : ?>
                                    <div class="item-excerpt"><?php echo wp_kses_post($case_study_except); ?></div>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
    ...
    <?php if (!empty($next_link) && $layout == 'masonry' && $pagination_type == 'loadmore') { ?>
        <div class="ct-load-more">
           <span class="btn">
                <i class=""></i>
                <?php echo esc_html__('More News', 'multio') ?>
            </span>
        </div>
    <?php } ?>
</div>