...
<ul class="ct-portfolio-details">
    <li>
        <label><i class="fa fa-tag"></i><?php echo esc_html__('Category:', 'multio'); ?></label>
        <?php the_terms( get_the_ID(), 'portfolio-category', '', ', ' ); ?>
    </li>

    <?php if(!empty($portfolio_date)) { ?>
        <li>
            <label><i class="fa fa-calendar"></i><?php echo esc_html__('Date:', 'multio'); ?></label>
    ...
    <?php if(!empty($portfolio_client)) : ?>
        <li>
            <label><i class="fa fa-user"></i><?php echo esc_html__('Client:', 'multio'); ?></label>
            <span><?php echo esc_attr($portfolio_client); ?></span>
        </li>
    <?php endif; ?>
    <?php if(!empty($portfolio_website)) : ?>
        <li>
            <label><i class="fa fa-external-link"></i><?php echo esc_html__('Website:', 'multio'); ?></label>
