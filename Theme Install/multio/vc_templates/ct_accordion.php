            ...
            <?php foreach ($accordion as $key => $value) {
                ...
                <div class="card">
                    <div class="card-header" id="heading-<?php echo esc_attr($key_id.$key) ?>">
                        <h3 class="card-title">
                            <a href="#collapse-<?php echo esc_attr($key_id.$key) ?>" data-toggle="collapse" data-target="#collapse-<?php echo esc_attr($key_id.$key) ?>" aria-expanded="<?php if($key == ($active_section - 1)) { echo 'true'; } else { echo 'false'; } ?>" aria-controls="collapse-<?php echo esc_attr($key_id.$key) ?>">
                              <?php echo esc_attr($ac_title); ?>
                              <i class="fac fac-angle-down"></i>
                            </a>
                        </h3>
                    </div>
